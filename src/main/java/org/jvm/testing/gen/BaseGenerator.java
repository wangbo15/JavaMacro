...
//            case 2: return "0"+Integer.toOctalString(r.nextInt())+"f";
    ...
    public static String stringGenWithoutQuotation(Random r)
    {
        return RandomStringUtils.randomAlphanumeric(r.nextInt(10)+1);
    }
    ...
    public static String alphanumericStringGen(Random r, int len){
